...
experiment_name = '{}_perfect{}_plan{}_follow{}_nenv{}_sticky{}_gamma{}_world{}_stage{}_trained_on{}'.format(reward_type, nodeath_name, plan_step, follow_steps, num_envs,sticky_prob, gamma, world, stage, trained_on)
