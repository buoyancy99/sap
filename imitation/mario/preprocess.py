...
def Rollout_To_TF(rollout_path='{}/Datasets/MarioRaw'.format(os.getenv('DATASET_ROOT')), savedir = '{}/Datasets/MarioImitation'.format(os.getenv('DATASET_ROOT')), n_worker = 10):
...
if __name__ == "__main__":
    Rollout_To_TF(rollout_path='{}/Datasets/MarioRaw'.format(os.getenv('DATASET_ROOT')), savedir='{}/Datasets/MarioImitation'.format(os.getenv('DATASET_ROOT')), n_worker=30)