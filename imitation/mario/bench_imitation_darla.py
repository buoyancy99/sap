...
from imitation.mario.imitation_model_darla import imitation_model
import os
import numpy as np
import cv2
...
experiment_name = 'imitation_darla_world{}_stage{}_trained_on'.format(world, stage, trained_on)
